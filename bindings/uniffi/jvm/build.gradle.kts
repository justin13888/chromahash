...
version = "0.7.2" // tracks the chromahash core crate version
...
tasks.test {
    ...
    // change and reported the task UP-TO-DATE across an edit to them.
    // `mise run test` then passed without running the conformance gate at all.
    // CI checks
